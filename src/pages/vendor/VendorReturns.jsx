      ...
      <div className="vendor-returns-kpi-grid">
        ...
        <div className="returns-kpi-card">
          ...
          <div className="kpi-content">
            ...
            <span className="kpi-subtext">Arrived for verification</span>
          </div>
        </div>
        ...
        <div className="returns-kpi-card">
          ...
          <div className="kpi-content">
            <span className="kpi-label">Restocked Catalog</span>
            <strong className="kpi-value">{metrics.passed + metrics.credited}</strong>
            <span className="kpi-subtext">Quality passed &amp; restored</span>
          </div>
        </div>
        ...
        <div className="returns-kpi-card">
          ...
          <div className="kpi-content">
            <span className="kpi-label">Refunds Settled</span>
            <strong className="kpi-value">₹{metrics.totalRefunded.toLocaleString("en-IN")}</strong>
            <span className="kpi-subtext">{metrics.credited} credited to wallet</span>
          </div>
        </div>
